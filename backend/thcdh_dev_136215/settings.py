"""
Django settings for thcdh_dev_136215 project.
...
ROOT_URLCONF = 'thcdh_dev_136215.urls'
...
WSGI_APPLICATION = 'thcdh_dev_136215.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Thcdh Support <support@thcdh-dev-136215.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "thcdh_dev_136215 API",
    "DESCRIPTION": "API documentation for thcdh_dev_136215 App",
    "VERSION": "v1",
}
